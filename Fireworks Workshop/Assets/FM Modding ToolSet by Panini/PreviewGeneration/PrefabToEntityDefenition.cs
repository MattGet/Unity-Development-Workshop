...
#region NoImage
    ...
    [MenuItem("Assets/Prefab To Entity/Default Fireworks/No Image")]
    public static void Prefab2Entity3()
    {
        GameObject Prefab = Selection.activeGameObject;
    ...
    [MenuItem("Assets/Prefab To Entity/Shell/No Image")]
    public static void Prefab2EntityShell3()
    {
        GameObject Prefab = Selection.activeGameObject;
    ...
    [MenuItem("Assets/Prefab To Entity/Mortar/No Image")]
    public static void Prefab2EntityMortar3()
    {
        GameObject Prefab = Selection.activeGameObject;
    ...
    [MenuItem("Assets/Prefab To Entity/Prop/No Image")]
    public static void Prefab2EntityProp3()
    {
        GameObject Prefab = Selection.activeGameObject;
