...
{
    [MenuItem("Assets/Prefab To Entity/Default Fireworks")]
    public static void Prefab2Entity()
    {
        ...
        Sprite icon = CaptureImage(Prefab, folderPath);
    ...
    [MenuItem("Assets/Prefab To Entity/Shell")]
    ...
    [MenuItem("Assets/Prefab To Entity/Mortar")]
    ...
    [MenuItem("Assets/Prefab To Entity/Prop")]
    ...
    public static Sprite CaptureImage(GameObject pref, string path)
    {
        int width = 512;
        int height = 512;
